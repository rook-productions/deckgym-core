...
enum Commands {
    ...
    Simulate {
        ...
        /// Available codes: aa, et, r, h, w, m<iterations>, mr<iterations>, v, e<depth>, er,
        /// l<depth>, o<depth>k<K>
        /// Example: e2 = ExpectiMiniMax with depth 2, l3 = the same with the learned value
        /// function, o2 = opponent-aware search at depth 2
